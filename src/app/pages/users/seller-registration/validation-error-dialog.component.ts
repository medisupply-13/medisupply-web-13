  ...
  template: `
    <div class="validation-error-dialog">
      <h2 mat-dialog-title>
        ...
        {{ data.title || ('validationErrorsTitle' | translate) }}
      </h2>
      
      <mat-dialog-content>
        <div class="errors-section" *ngIf="data.errors && data.errors.length > 0">
          <h3 class="section-title">{{ 'validationErrorsSection' | translate }}</h3>
          <ul class="error-list">
        ...
        <div class="warnings-section" *ngIf="data.warnings && data.warnings.length > 0">
          <h3 class="section-title warning">{{ 'validationWarningsSection' | translate }}</h3>
      ...
      <mat-dialog-actions align="end">
        <button mat-flat-button color="primary" (click)="onClose()">
          {{ 'validationCloseButton' | translate }}
        </button>
      </mat-dialog-actions>
    </div>
  `,
